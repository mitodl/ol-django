...
class TimestampedModelAdmin(admin.ModelAdmin):
    ...
    def get_list_display(self, request):  # pragma: no cover  # noqa: D102
    ...
    def get_readonly_fields(self, request, obj=None):  # pragma: no cover  # noqa: D102
    ...
    def get_exclude(self, request, obj=None):  # pragma: no cover  # noqa: D102
