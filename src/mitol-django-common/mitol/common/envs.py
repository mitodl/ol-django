...
def parse_bool(
    name: str, value: str, default: bool
...
def parse_str(name: str, value: str, default: str):  # pylint: disable=unused-argument
    """
...
def parse_list_literal(
    name: str, value: Union[str, List[Any]], default: List[Any]
) -> List[str]:
    """
...
def parse_delimited_list(name, value, default):  # pylint: disable=unused-argument
    """
    Parses a comma separated string into a list
