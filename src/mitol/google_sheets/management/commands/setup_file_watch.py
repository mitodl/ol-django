"""
Makes a request to receive push notifications spreadsheets are updated
"""
import sys
...
from mitol.google_sheets.api import (
...
class Command(BaseCommand):
    """
    Makes a request to receive push notifications when spreadsheets are updated
    """
