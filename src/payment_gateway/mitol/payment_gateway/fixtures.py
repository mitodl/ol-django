...
needed; they work as data classes.
...
a Session (like, say, from stripe_checkout_session) in there. You'll want to
make sure to update the type too.

Fixture data is compressed into a single line to allow for the pragma (these
contain IDs that look like secrets).
"""
