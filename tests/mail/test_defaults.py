...
def test_can_email_user(mocker):
    ...
    assert can_email_user(mocker.Mock(email="user@localhost")) is True
    assert can_email_user(mocker.Mock(email="")) is False
    assert can_email_user(mocker.Mock(email=None)) is False
