...
def test_test_app_json_modified_fails(mocker):
    ...
    usually imported into projects for reuse.
    """
    mocker.patch("builtins.open", mocker.mock_open(read_data=json.dumps(dict(a=1))))  # noqa: C408
    mocker.patch("mitol.common.envs.generate_app_json", return_value=dict(a=1243))  # noqa: C408
