...
# MITOL_MAIL_FORMAT_RECIPIENT_FUNC = "mitol.mail.defaults.format_recipient"  # noqa: E501, ERA001
# MITOL_MAIL_CAN_EMAIL_USER_FUNC = "mitol.mail.defaults.can_email_user"  # noqa: ERA001
# MITOL_MAIL_CONNECTION_BACKEND = "anymail.backends.mailgun.EmailBackend"  # noqa: E501, ERA001
